...
export function Hero() {
  return (
    <section id="home" className="min-h-screen flex items-center justify-center pt-20 relative px-6">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-teal-900/20 via-slate-950 to-slate-950 -z-10" />
      ...
      <div className="max-w-5xl mx-auto w-full grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          <div className="space-y-4">
            <motion.p 
              ...
              className="text-teal-400 font-mono tracking-wide"
            >
              Hi, I'm
            </motion.p>
          ...
          <div className="flex flex-wrap items-center gap-6 pt-4">
            <a 
              href="/resume.pdf" 
              download
              className="inline-flex items-center gap-2 px-6 py-3 bg-teal-500 hover:bg-teal-400 text-slate-950 font-medium rounded-lg transition-colors shadow-lg shadow-teal-500/20"
            >
            ...
            <div className="flex gap-4">
              <a href="https://github.com/pratik04032" target="_blank" rel="noreferrer" 
                 className="p-3 bg-slate-800/50 hover:bg-slate-800 rounded-full text-slate-300 hover:text-white transition-colors ring-1 ring-white/10 hover:ring-white/30">
        ...
        >
          <div className="aspect-square rounded-full border border-slate-800 bg-slate-900/50 flex items-center justify-center p-8 relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-tr from-teal-500/10 to-blue-500/10" />
            {/* Abstract visual representation instead of personal photo */}
            <div className="w-full h-full border border-slate-700/50 rounded-full animate-[spin_60s_linear_infinite] relative">
            ...
            <div className="absolute w-3/4 h-3/4 border border-slate-700/50 rounded-full animate-[spin_40s_linear_infinite_reverse] relative">
